...
export default function NewsOverviewPage() {
  ...
  const newsTagsQuery: any = null;
  const mainNewsQuery: any = null;
  const newsQuery: any = null;

  // ===========================================================================
  // Derived States
  // ===========================================================================

  // type NewsDataType = NonNullable<NonNullable<NonNullable<GetAllNewsQuery["allNews"]>["docs"]>[0]>;

  const newsToDisplay: any = null;
